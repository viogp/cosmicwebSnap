...
def run_all(snapnum):
	data_fn='/cosma5/data/GRID/jch/millgas/snapdir_%03i/500_dm_%03i'%(snapnum, snapnum)
	output_fn='/gpfs/data/nmccull/mr7corr/lee/xi_real_sn%03i.txt'%snapnum
	param_fn='/cosma/home/nmccull/code/CUTE-1.2/CUTE_box/paramfiles/millgas/params_sn%i.txt'%snapnum
	batch_fn='/cosma/home/nmccull/code/scripts/millgas/batch_script_cute%03i.sh'%snapnum
	print batch_fn
	print param_fn

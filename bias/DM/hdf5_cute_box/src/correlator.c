...
void corr_mono_box_bf(lint np,float *pos,
...
void corr_mono_box_pm(float *grid,double corr[],double ercorr[],
		      unsigned long long hh[])
{
  //////
  // Correlator for monopole in the periodic-box case
...
static int limit_dist2_point2box(float *x,float *x_l,float *x_h,
...
static void bin_branch(branch *br,float *x,unsigned long long hh[])
{
  //////
...
void corr_mono_box_tree(lint np,float *pos,branch *tree,
			unsigned long long hh[])
{
  //////
  // Correlator for monopole in the periodic-box case
